            ...
            <div className="grid grid-cols-1 mb-14 mt-5 lg:mt-20">
                <div className="block lg:grid grid-cols-3 gap-5 container mx-auto">
                    ...
                    <div className="mx-auto py-5 text-blue-700 text-center">
                        <h2 className="lg:block grid justify-items-center text-3xl">Obtén hasta un  <strong className=" font-bold text-4xl text-orange-500">40%</strong> de descuento en productos seleccionados </h2>                
                        <h3 className="block grid justify-items-center text-2xl mt-3 lg:mt-0 text-center">por comprar en nuestro sitio web - valido hasta el 30 de abril</h3> 
                    </div>
                    <div className="mx-auto py-5 flex justify-center lg:block">
                        <strong className="text-lg rounded-3xl lg:mt-3 text-white bg-blue-700 px-4 py-2">¡Pidelo ahora!</strong>                
                    </div>
                </div>
