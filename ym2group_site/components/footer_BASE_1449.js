        ...
        <div className="bg-cyan-700 text-white">
            <footer className=" container mx-auto p-4 sm:p-6 dark:bg-gray-900">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 YM2 GROUP C.A. Todos los derechos reservados.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="#" className="text-white hover:text-orange-500 dark:hover:text-white">
